...
|--------|--------|--------|--------|
| Plate Detection | YOLOv8n | Full image | Plate bounding boxes |
| Character Recognition | YOLOv8s | Plate crop | Character labels + positions |
| Post-processing | Rule-based | Raw OCR text | Corrected plate string |
...
- [x] Plate Detection using YOLOv8
- [x] Character Detection using YOLOv8
- [x] Vietnamese Plate Post-processing
- [x] CLI Application
- [x] Desktop GUI
- [x] Unit Testing
...
- Custom datasets and publicly available research resources
...
#   v i e t n a m e s e - a l p r - s y s t e m  
 #   v i e t n a m e s e - a l p r - s y s t e m  
 